python punctuate_capitalize_nmt.py \
    ...
    --output_text ~/data/iwslt/IWSLT-SLT/eval/en-de/IWSLT.tst2019/for_testing_punctuation_model/nmt/wiki_wmt_large6x6_bs400000_steps400000_lr2e-4_autoregressive_labels.txt \

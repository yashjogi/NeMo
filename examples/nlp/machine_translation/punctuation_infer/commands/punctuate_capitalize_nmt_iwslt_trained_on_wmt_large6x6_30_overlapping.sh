...
pred_labels="${output_dir}/wmt_large6x6_bs400000_steps300000_lr2e-4_30_overlapping_autoregressive_labels.txt"
python punctuate_capitalize_nmt.py \
    --input_text "${work_dir}/text_iwslt_en_text.txt" \
    --output_text "${output_dir}/wmt_large6x6_bs400000_steps300000_lr2e-4_30_overlapping_text.txt" \
...
python compute_metrics.py \
    ...
    --output "${output_dir}/wmt_large6x6_bs400000_steps300000_lr2e-4_30_overlapping_scores.json" \

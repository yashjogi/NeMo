...
#SBATCH -J "ent_aiapps_asr:punctuation_capitalization_using_NMT_large6x6_bs400000_steps300000"  # job name (<< CHANGE ! >>)
...
EXPNAME="nmt_wmt_large6x6_bs400000_steps300000_lr2e-4"

# Mounts
SLURM_ACCOUNT='ent_aiapps'
USERID='apeganov'
LUSTRE_ACCOUNT_PREFIX=/gpfs/fs1/projects/${SLURM_ACCOUNT}
DATA="${LUSTRE_ACCOUNT_PREFIX}/datasets/data/punctuation_capitalization/wmt_92_128_14.12.2021"

python punctuate_capitalize_infer.py \
  ...
  --model_path '~/NWInf_results/autoregressive_punctuation_capitalization/evelina_model_no_quotes_draco_bert_base/checkpoints/Punctuation_and_Capitalization.nemo' \
  --max_seq_length 512 \
  --step 510 \
  --margin 0 \

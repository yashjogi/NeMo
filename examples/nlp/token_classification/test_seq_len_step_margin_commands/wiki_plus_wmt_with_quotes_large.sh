python test_seq_len_step_margin.py \
  --model_path ~/NWInf_results/autoregressive_punctuation_capitalization/evelina_wiki_wmt_large/punctuation_and_capitalization_BERT_large_lr6e-5_warmupratio0.06_steps100k_wasrestore_4.12.2021.nemo \

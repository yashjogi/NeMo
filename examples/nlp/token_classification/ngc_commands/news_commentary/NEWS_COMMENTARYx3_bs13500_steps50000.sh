...
python punctuation_capitalization_train_evaluate.py --config-path=conf/ted \
    ...
    exp_manager.wandb_logger_kwargs.name=NEWS_COMMENTARY_x3_bs13500_steps300000 \
...
ngc batch run \
  ...
  --name "ml-model.bert NEWS_COMMENTARY_x3_punctuation_capitalization_bs13500_steps300000" \

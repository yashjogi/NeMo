...
#
#     precision = '16'  # TODO: take precision from config
#     tensor_model_parallel_size = 1  # TODO from config / args
#
...
#  '/raid/purnendu/models/2-1pt3B-300k/1.3B_bf16/edited_nemo/gpt1pt3B-300k-rank1.nemo'
    ...
    # '/raid/purnendu/models/3-squadpartial-scripted/rank0/gen_squad_ft_interm2_rank0.nemo'

    model = MegatronGPTModel.restore_from(
        '/raid/purnendu/models/4-new1pt3B/megatron_gpt.nemo', trainer=trainer
    )

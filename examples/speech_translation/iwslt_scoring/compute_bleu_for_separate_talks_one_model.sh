...
python iwslt_scoring/xml_2_separate_files.py -i "${reference}" -o "${split_reference_dir}"
python iwslt_scoring/xml_2_separate_files.py -i "${translation}" -o "${split_translation_dir}"
